...
/* String:atleast (new native_method) */
...
/* String:atmost (new native_method) */
...
obj_ref native_Boolean_not() {
    ...
    assert_is_type(this, the_class_Boolean);
    obj_Boolean this_boolean = (obj_Boolean) this;
    log_debug("NOT %d", this_boolean->value);
    if (this_boolean->value == -1) {
        return lit_false;
    } else {
        return lit_true;
    }
        ...
        .vtable =
                {
                 ...
                 method_Obj_print, // PRINT
                 method_Obj_equals, // EQUALS
                 method_Boolean_and, // AND
                 method_Boolean_or, // OR
                 method_Boolean_not // NOT
                }
};
